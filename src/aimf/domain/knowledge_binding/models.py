...
input contract for a future Assessment Graph. It never embeds repository
identity into the Engineering Knowledge Graph.
"""
...
KNOWLEDGE_BINDING_RESULT_VERSION = "1.1.0"
